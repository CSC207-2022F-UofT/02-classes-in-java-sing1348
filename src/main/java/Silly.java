...
public class Silly implements Comparable<Silly>{
    ...
    public Silly(String a, String b){ this.name = a + b;}
        ...
        /**
         * Creates a new Silly object.
         * This constructor takes in two String variables as an arguments.
         *
         * @param a first name of this Silly instance
         * @param b second name of this Silly instance.
         *
         */
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof Silly)){
            return false;
        } else if (o.toString().equals(this.name)){
            return true;
        }
